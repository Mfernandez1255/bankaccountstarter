...
export default function Transactions() {
  ...
  return (
    ...
    <section className="transactions container">
          ...
          <div>
            <button onClick={() => dispatch(deposit({ amount }))} default name="deposit">
            Deposit
            </button>
            <button onClick={() => dispatch(withdrawal({ amount }))} name="withdraw">
            Withdraw
          </button>
          </div>
          </div>
          ...
          <label>
            ...
            <button onClick={() => dispatch(transfer({ amount }))} name="transfer">
            Transfer
            </button>
        </div>
      </form>
